...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const preferred = grants.find((grant) => grant.modulo_code === "gptads4all") || grants.find((grant) => grant.company_id === (user as any)?.company_id) || grants[0];
