...
| Multi Shopper Dashboard | EMP_MULTI_SHOPPER | `companies/EMP_MULTI_SHOPPER/projects/PROY-001_DASHBOARD/` | https://multi-shopper.vercel.app | Purchasing IA Engine: cotizaciones, productos, proveedores, documentos y precios historicos | Factory API + schema `multi_shopper` por project/env | `vertical_multi_shopper/*`, `vertical_auth_security/*` |
