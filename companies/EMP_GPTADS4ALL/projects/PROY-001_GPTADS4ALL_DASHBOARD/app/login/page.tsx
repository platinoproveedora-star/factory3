    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-8 text-slate-900">
      <section className="w-full max-w-md">
        <div className="mb-5 text-center text-white">
          ...
          <h1 className="mt-4 text-3xl font-semibold text-white">GPTAds4All</h1>
          <p className="mt-2 text-sm leading-6 text-slate-300">
            Campanas, intenciones, creativos y exportaciones para tu empresa.
          </p>
        </div>
        ...
        <form onSubmit={submit} className="rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-xl font-semibold text-slate-950">Entrar al generador</h2>
        ...
        <div className="mt-4 grid gap-2 text-center sm:grid-cols-3">
          <LoginMetric label="Ideas" value="IA" />
          <LoginMetric label="Creativos" value="10+" />
          <LoginMetric label="Export" value="CSV/JSON" />
        </div>
      </section>
    </main>
  );
