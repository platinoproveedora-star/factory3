...
import { ArrowUpRight, FileSpreadsheet, FileText, Megaphone, ReceiptText, ShoppingBasket, Store, Truck } from "lucide-react";
...
const MODULES: Record<string, { title: string; description: string; href: string; icon: any; external?: boolean }> = {
  ...
  factu4all: {
    title: "Factu4All",
    description: "Facturacion CFDI 4.0 multiempresa: emisores, clientes fiscales, productos y timbrado.",
    href: process.env.NEXT_PUBLIC_FACTU4ALL_URL || "#",
    icon: FileText,
    external: true
  }
};
