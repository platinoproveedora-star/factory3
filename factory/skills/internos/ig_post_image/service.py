"""Service for ig_post_image - publishes an image to Instagram via Meta Graph API."""
...
class IgPostImageService:
    ...
    def _validar(self, context: dict) -> tuple[bool, str | None]:
        ...
        if not image_url or not isinstance(image_url, str):
            return False, "image_url es requerido y debe ser texto"
        if not image_url.startswith("http"):
            return False, "image_url debe ser una URL publica valida"
        return True, None
    ...
    def _ejecutar(self, context: dict) -> dict:
        ...
        try:
            container_body: dict = {"image_url": image_url}
            if caption:
            ...
            return {"ok": True, "data": {"post_id": post_id, "permalink": permalink, "creation_id": creation_id}}
